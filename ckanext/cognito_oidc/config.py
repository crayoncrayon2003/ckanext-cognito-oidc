...
CONFIG_BASE_URL = "ckanext.cognito_oidc.base_url"
CONFIG_CLIENT_ID = "ckanext.cognito_oidc.client_id"
CONFIG_CLIENT_SECRET = "ckanext.cognito_oidc.client_secret"

CONFIG_AUTH_PATH = "ckanext.cognito_oidc.auth_path"
DEFAULT_AUTH_PATH = "/oauth2/authorize"

CONFIG_TOKEN_PATH = "ckanext.cognito_oidc.token_path"
DEFAULT_TOKEN_PATH = "/oauth2/token"

CONFIG_USERINFO_PATH = "ckanext.cognito_oidc.userinfo_path"
DEFAULT_USERINFO_PATH = "/oauth2/userinfo"

CONFIG_REDIRECT_PATH = "ckanext.cognito_oidc.redirect_path"
DEFAULT_REDIRECT_PATH = "/user/login/cognito_oidc/callback"

CONFIG_ERROR_REDIRECT = "ckanext.cognito_oidc.error_redirect"
DEFAULT_ERROR_REDIRECT = None

CONFIG_SCOPE = "ckanext.cognito_oidc.scope"
DEFAULT_SCOPE = "openid+profile+aws.cognito.signin.user.admin"

CONFIG_SAME_ID = "ckanext.cognito_oidc.use_same_id"
DEFAULT_SAME_ID = False

CONFIG_MUNGE_PASSWORD = "ckanext.cognito_oidc.munge_password"
DEFAULT_MUNGE_PASSWORD = False


def client_id() -> str:
    """ClientID for SSO application"""
    id_ = os.environ.get('CKANEXT_COGNITO_OIDC_CLIENT_ID')
    if not id_:
...
def client_secret() -> str:
    ...
    secret_ = os.environ.get('CKANEXT_COGNITO_OIDC_CLIENT_SECRET')
    if not secret_:
...
def base_url() -> str:
    ...
    url = os.environ.get('CKANEXT_COGNITO_OIDC_BASE_URL')
    if not url:
